...
jupyternotebook_token=$(sudo singularity exec /data/containers/datascience-notebook_"$jupyternotebook_version.sif" jupyter notebook list | grep -oP -m 1 '8888.{0,}' | awk '{print $1}')
